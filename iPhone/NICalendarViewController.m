...
@implementation NICalendarViewController
...
- (void) viewDidLoad{
	[super viewDidLoad];
  self.tabBarItem = [[[UITabBarItem alloc] initWithTitle:@"Calendar" image:[UIImage imageNamed:@"Calendar-Month.png"] tag:2] autorelease];
